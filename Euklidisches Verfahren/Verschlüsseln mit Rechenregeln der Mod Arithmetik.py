...
# Bestimmen von e: e ist eine primzahl, e < phi_n, e und phi_n sind teilerfremd (andere Primfaktoren)
...
def modulare_potenzierung(base, exponent, modul):
    result = 1
    base = base % modul
...
C = modulare_potenzierung(M, e, n)
M_2 = modulare_potenzierung(C, d, n)
